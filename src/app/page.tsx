...
export default function LandingPage() {
    return (
        <div className="min-h-screen bg-white relative">
            ...
            <div className="fixed inset-0 pointer-events-none z-10 shadow-[inset_0_0_80px_rgba(59,130,246,0.4)] md:shadow-[inset_0_0_120px_rgba(59,130,246,0.3)] animate-pulse" />
